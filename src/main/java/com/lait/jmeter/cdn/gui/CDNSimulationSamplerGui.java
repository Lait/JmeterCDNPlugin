...
public class CDNSimulationSamplerGui extends AbstractSamplerGui implements ItemListener {
    ...
    private JComboBox sourceIpType = new JComboBox(CDNSimulationSampler.getSourceTypeList());
    ...
    public void modifyTestElement(TestElement sampler) {
        ...
        final CDNSimulationSampler samplerBase = (CDNSimulationSampler) sampler;
    ...
    protected JPanel createSourceAddrPanel() {
        ...
        if (!isAJP) {
            ...
            sourceIpType.setSelectedIndex(CDNSimulationSampler.SourceType.HOSTNAME.ordinal()); //default: IP/Hostname
    ...
    public void clearGui() {
        ...
        concurrentPool.setText(String.valueOf(CDNSimulationSampler.CONCURRENT_POOL_SIZE));
